        ...
        <div className="container flex items-center justify-between px-5 py-4 sm:px-5 sm:py-4 md:px-10 md:py-5 lg:px-0 lg:py-5">
          ...
          <div className="flex gap-4">
            <div className="hidden gap-3 md:flex">
              <button className="max-w-32 text-gray-600 font-semibold">
                Log in
              </button>
              <button className="rounded-lg bg-primary px-4 py-2 text-base font-semibold text-white transition-all hover:bg-primary/70">
                Sign up
              </button>
            </div>
            <button
